...
//		colorBarView.setNeedsDisplay()
	...
	private func growIndicator() {
		...
		UIView.animate(withDuration: HIGHLIGHT_ANIMATION_TIME, delay: 0.0, options: [.curveEaseIn], animations: {
	...
	private func shrinkIndicator() {
		...
		UIView.animate(withDuration: HIGHLIGHT_ANIMATION_TIME, delay: 0.0, options: [.curveEaseOut], animations: {
	...
	open override var accessibilityTraits: UIAccessibilityTraits {
		get {
            ...
            t.insert(UIAccessibilityTraits.adjustable)
